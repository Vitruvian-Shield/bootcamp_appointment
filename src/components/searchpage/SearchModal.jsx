    ...
    <div>
      ...
      >
        <ModalContent sx={style}>
          <Typography color={"black"} id="parent-modal-title" className="modal-title">
            استان مد نظر خود را انتخاب کنید
          </Typography>
          {cities_list.map((item,index) =>{ return(
                    <>
                    <ModalButton  value={province[index]}>{item.province}</ModalButton>
                    </>
                    )})}
          <ChildModal />
        </ModalContent>
